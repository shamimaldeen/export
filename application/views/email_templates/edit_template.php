...
<div class="row">
  <div class="col-lg-12">
	<h3 class="pull-left">Edit Template</h3>
  ...
  <div class="col-lg-12">
	<div class="panel panel-primary">
	  <div class="panel-heading">
		<h3 class="panel-title"><i class="fa fa-user"></i> Edit template </h3>
	  </div>
   ...
   <div class="col-lg-6"> 
		...
		?>
	<form role="form" method="POST" action="<?php echo site_url('email_templates/edit/'.$email_template->template_id); ?>">
	 <input type="hidden" name="template_id" value="<?php echo $email_template->template_id;?>" />
	 <div class="form-group">
		<label>Template Title</label>
		<input class="form-control" name="template_title" value="<?php echo $email_template->template_title;?>"/>
		<?php echo form_error('template_title'); ?>
	  </div>

	  <div class="form-group">
		<label>Template Body</label>
		<textarea class="form-control"  name="template_body" id="template_body" rows="10"><?php echo $email_template->email_body;?></textarea>
		<?php echo form_error('template_body'); ?>
	  </div>

	  <button type="submit" class="btn btn-large btn-success" name="edittemplatebtn" value="Edit template">Update Template</button>
	  <button type="reset" class="btn btn-large btn-danger">Reset Form</button>  
		...
		<p><label>Invoice Tags</label></p>
		 ...
		 <a href="#" class="text-tag" data-tag="[invoice_created_date]">Invoice Created Date</a><br>
